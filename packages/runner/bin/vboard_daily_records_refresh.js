...
const leads = read(path.join(ROOT,"crm/leads.md"), "# VBOARD CRM Leads\n\nNo leads recorded yet.\n");
const bankStatus = readJson("/var/log/vboard/bank-finance-status.last.json") || finance;
const financeSummary = finance?.summary || bankStatus?.summary || {};
const financeValidation = finance?.validation || bankStatus?.validation || {};
