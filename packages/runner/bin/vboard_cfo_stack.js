...
const CHART_OF_ACCOUNTS = {
  ...
  "Expenses:Software:AI-fallback LLM provider": { type: "expense", desc: "fallback LLM provider inference" },
  "Expenses:Software:AI-remote LLM provider": { type: "expense", desc: "remote LLM provider inference" },
  ...
  "Expenses:Software:chair LLM provider": { type: "expense", desc: "chair LLM provider subscriptions" },
...
const CLASSIFICATION_RULES = [
  ...
  [/^PRIMARY_LLM/i, "Expenses:Software:AI-primary LLM provider", "primary LLM provider API"],
  [/^REVIEWER_LLM/i, "Expenses:Software:AI-reviewer LLM provider", "reviewer LLM provider API"],
  [/^FALLBACK LLM/i, "Expenses:Software:AI-fallback LLM provider", "fallback LLM provider inference"],
  [/^REMOTE LLM/i, "Expenses:Software:AI-remote LLM provider", "remote LLM provider inference"],
  ...
  [/^CHAIR LLM \*Play|^chair LLM provider Chrome/i, "Expenses:Software:chair LLM provider", "chair LLM provider subscription"],
  ...
  [/^CASH SERVICES/i, "Expenses:Uncategorized", "Cash withdrawal - owner review required"],
  [/^retrait\b|^DAB\b/i, "Expenses:Uncategorized", "ATM withdrawal - owner review required"]
];
...
function renderAccounts() {
  const lines = [
    "; V-Board CFO - Chart of Accounts",
    `; Generated by cfo-stack ${VERSION}`,
    "",
    "option \"title\" \"V-Board CFO\"",
...
function renderMonthlyLedger(month, txs, runningBalance) {
  const lines = [
    `; V-Board CFO - Transactions ${month}`,
    `; Generated by cfo-stack ${VERSION}`,
    ""
  ];
...
function renderRules() {
  const lines = [
    "# V-Board CFO - Classification Rules",
    `# Generated by cfo-stack ${VERSION}`,
    "",
    "rules:"
  ];
