...
const ownerBlockStart = '<!-- AZZCO_OVH_OWNER_COMMANDS_START -->';
const ownerBlockEnd = '<!-- AZZCO_OVH_OWNER_COMMANDS_END -->';
const ownerBlock = `${ownerBlockStart}

# AZZCO OVH Owner Command Clarification

- Proactive, unsolicited OVH-to-owner Telegram contact is reserved for P0 incidents and critical infrastructure alerts.
- Owner-requested Telegram replies, diagnostics, smoke tests, reports, and confirmations are allowed when Azer explicitly asks for them.
- Do not refuse an owner-requested operational confirmation only because it is not P0.
- For non-owner users, remain a professional AZZ&CO LABS representative and do not disclose internal architecture, secrets, legal/accounting data, or private operational details.
